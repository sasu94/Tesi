-- --------------------------------------------------------
-- Host:                         127.0.0.1
-- Versione server:              5.7.18-log - MySQL Community Server (GPL)
-- S.O. server:                  Win64
...
-- Dump della struttura di tabella information_schema.CHARACTER_SETS
...
-- Dump della struttura di tabella information_schema.COLLATIONS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.COLLATION_CHARACTER_SET_APPLICABILITY
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.COLUMNS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.COLUMN_PRIVILEGES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.ENGINES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.EVENTS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.FILES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.GLOBAL_STATUS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.GLOBAL_VARIABLES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_BUFFER_PAGE
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_BUFFER_PAGE_LRU
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_BUFFER_POOL_STATS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMP
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMPMEM
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMPMEM_RESET
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMP_PER_INDEX
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_CMP_RESET
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_BEING_DELETED
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_BEING_DELETED` (
  `DOC_ID` bigint(21) unsigned NOT NULL DEFAULT '0'
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_CONFIG
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_DEFAULT_STOPWORD
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_DEFAULT_STOPWORD` (
  `value` varchar(18) NOT NULL DEFAULT ''
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_DELETED
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_FT_DELETED` (
  `DOC_ID` bigint(21) unsigned NOT NULL DEFAULT '0'
) ENGINE=MEMORY DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_INDEX_CACHE
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_FT_INDEX_TABLE
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_LOCKS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_LOCK_WAITS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_METRICS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_COLUMNS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_DATAFILES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_FIELDS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_FOREIGN
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_FOREIGN_COLS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_INDEXES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_TABLES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_TABLESPACES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_TABLESTATS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_SYS_VIRTUAL
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_TEMP_TABLE_INFO
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.INNODB_TRX
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.KEY_COLUMN_USAGE
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.OPTIMIZER_TRACE
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.PARAMETERS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.PARTITIONS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.PLUGINS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.PROCESSLIST
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.PROFILING
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.REFERENTIAL_CONSTRAINTS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.ROUTINES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.SCHEMATA
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.SCHEMA_PRIVILEGES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.SESSION_STATUS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.SESSION_VARIABLES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.STATISTICS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.TABLES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.TABLESPACES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.TABLE_CONSTRAINTS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.TABLE_PRIVILEGES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.TRIGGERS
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.USER_PRIVILEGES
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella information_schema.VIEWS
...
-- Dump della struttura del database mysql
CREATE DATABASE IF NOT EXISTS `mysql` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mysql`;

-- Dump della struttura di tabella mysql.columns_priv
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.db
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.engine_cost
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.event
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.func
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.general_log
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.gtid_executed
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.help_category
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.help_keyword
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.help_relation
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.help_topic
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.innodb_index_stats
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.innodb_table_stats
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.ndb_binlog_index
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.plugin
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.proc
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.procs_priv
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.proxies_priv
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.servers
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.server_cost
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.slave_master_info
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.slave_relay_log_info
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.slave_worker_info
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.slow_log
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.tables_priv
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.time_zone
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.time_zone_leap_second
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.time_zone_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.time_zone_transition
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.time_zone_transition_type
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella mysql.user
...
-- Dump della struttura del database performance_schema
CREATE DATABASE IF NOT EXISTS `performance_schema` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `performance_schema`;

-- Dump della struttura di tabella performance_schema.accounts
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.cond_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_current
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_history
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_history_long
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_summary_by_account_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_summary_by_host_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_summary_by_thread_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_summary_by_user_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_stages_summary_global_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_current
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_history
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_history_long
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_account_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_digest
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_host_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_program
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_thread_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_by_user_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_statements_summary_global_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_current
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_history
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_history_long
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_summary_by_account_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_summary_by_host_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_summary_by_thread_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_summary_by_user_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_transactions_summary_global_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_current
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_history
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_history_long
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_by_account_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_by_host_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_by_instance
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_by_thread_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_by_user_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.events_waits_summary_global_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.file_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.file_summary_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.file_summary_by_instance
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.global_status
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.global_variables
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.hosts
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.host_cache
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.memory_summary_by_account_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.memory_summary_by_host_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.memory_summary_by_thread_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.memory_summary_by_user_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.memory_summary_global_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.metadata_locks
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.mutex_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.objects_summary_global_by_type
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.performance_timers
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.prepared_statements_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_applier_configuration
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_applier_status
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_applier_status_by_coordinator
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_applier_status_by_worker
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_connection_configuration
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_connection_status
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_group_members
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.replication_group_member_stats
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.rwlock_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.session_account_connect_attrs
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.session_connect_attrs
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.session_status
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.session_variables
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.setup_actors
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.setup_consumers
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.setup_instruments
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.setup_objects
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.setup_timers
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.socket_instances
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.socket_summary_by_event_name
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.socket_summary_by_instance
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.status_by_account
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.status_by_host
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.status_by_thread
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.status_by_user
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.table_handles
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.table_io_waits_summary_by_index_usage
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.table_io_waits_summary_by_table
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.table_lock_waits_summary_by_table
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.threads
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.users
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.user_variables_by_thread
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella performance_schema.variables_by_thread
...
-- Dump della struttura del database sys
CREATE DATABASE IF NOT EXISTS `sys` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sys`;

-- Dump della struttura di procedura sys.create_synonym_db
DELIMITER //
...
-- Dump della struttura di procedura sys.diagnostics
DELIMITER //
...
-- Dump della struttura di procedura sys.execute_prepared_stmt
DELIMITER //
...
-- Dump della struttura di funzione sys.extract_schema_from_file_name
DELIMITER //
...
-- Dump della struttura di funzione sys.extract_table_from_file_name
DELIMITER //
...
-- Dump della struttura di funzione sys.format_bytes
DELIMITER //
...
-- Dump della struttura di funzione sys.format_path
DELIMITER //
...
-- Dump della struttura di funzione sys.format_statement
DELIMITER //
...
-- Dump della struttura di funzione sys.format_time
DELIMITER //
...
-- Dump della struttura di vista sys.host_summary
...
-- Dump della struttura di vista sys.host_summary_by_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.host_summary_by_file_io_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.host_summary_by_stages
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.host_summary_by_statement_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.host_summary_by_statement_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.innodb_buffer_stats_by_schema
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.innodb_buffer_stats_by_table
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.innodb_lock_waits
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.io_by_thread_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.io_global_by_file_by_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.io_global_by_file_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.io_global_by_wait_by_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.io_global_by_wait_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.latest_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di funzione sys.list_add
DELIMITER //
...
-- Dump della struttura di funzione sys.list_drop
DELIMITER //
...
-- Dump della struttura di vista sys.memory_by_host_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.memory_by_thread_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.memory_by_user_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.memory_global_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.memory_global_total
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
CREATE TABLE `memory_global_total` (
	`total_allocated` TEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;

-- Dump della struttura di vista sys.metrics
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.processlist
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.ps_check_lost_instrumentation
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di funzione sys.ps_is_account_enabled
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_is_consumer_enabled
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_is_instrument_default_enabled
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_is_instrument_default_timed
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_is_thread_instrumented
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_disable_background_threads
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_disable_consumer
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_disable_instrument
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_disable_thread
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_enable_background_threads
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_enable_consumer
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_enable_instrument
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_enable_thread
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_reload_saved
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_reset_to_default
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_save
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_disabled
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_disabled_consumers
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_disabled_instruments
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_enabled
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_enabled_consumers
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_setup_show_enabled_instruments
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_statement_avg_latency_histogram
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_thread_account
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_thread_id
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_thread_stack
DELIMITER //
...
-- Dump della struttura di funzione sys.ps_thread_trx_info
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_trace_statement_digest
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_trace_thread
DELIMITER //
...
-- Dump della struttura di procedura sys.ps_truncate_all_tables
DELIMITER //
...
-- Dump della struttura di funzione sys.quote_identifier
DELIMITER //
...
-- Dump della struttura di vista sys.schema_auto_increment_columns
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_index_statistics
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_object_overview
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_redundant_indexes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_tables_with_full_table_scans
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_table_lock_waits
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_table_statistics
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_table_statistics_with_buffer
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.schema_unused_indexes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.session
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.session_ssl_status
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statements_with_errors_or_warnings
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statements_with_full_table_scans
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statements_with_runtimes_in_95th_percentile
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statements_with_sorting
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statements_with_temp_tables
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.statement_analysis
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di procedura sys.statement_performance_analyzer
DELIMITER //
...
-- Dump della struttura di tabella sys.sys_config
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di funzione sys.sys_get_config
DELIMITER //
...
-- Dump della struttura di procedura sys.table_exists
DELIMITER //
...
-- Dump della struttura di vista sys.user_summary
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.user_summary_by_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.user_summary_by_file_io_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.user_summary_by_stages
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.user_summary_by_statement_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.user_summary_by_statement_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.version
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
CREATE TABLE `version` (
	`sys_version` VARCHAR(5) NOT NULL COLLATE 'utf8_general_ci',
	`mysql_version` VARCHAR(10) NOT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;

-- Dump della struttura di funzione sys.version_major
DELIMITER //
...
-- Dump della struttura di funzione sys.version_minor
DELIMITER //
...
-- Dump della struttura di funzione sys.version_patch
DELIMITER //
...
-- Dump della struttura di vista sys.waits_by_host_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.waits_by_user_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.waits_global_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.wait_classes_global_by_avg_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.wait_classes_global_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary_by_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary_by_file_io_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary_by_stages
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary_by_statement_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$host_summary_by_statement_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$innodb_buffer_stats_by_schema
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$innodb_buffer_stats_by_table
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$innodb_lock_waits
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$io_by_thread_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$io_global_by_file_by_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$io_global_by_file_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$io_global_by_wait_by_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$io_global_by_wait_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$latest_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$memory_by_host_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$memory_by_thread_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$memory_by_user_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$memory_global_by_current_bytes
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$memory_global_total
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
CREATE TABLE `x$memory_global_total` (
	`total_allocated` DECIMAL(41,0) NULL
) ENGINE=MyISAM;

-- Dump della struttura di vista sys.x$processlist
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$ps_digest_95th_percentile_by_avg_us
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$ps_digest_avg_latency_distribution
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$ps_schema_table_statistics_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_flattened_keys
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_index_statistics
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_tables_with_full_table_scans
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_table_lock_waits
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_table_statistics
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$schema_table_statistics_with_buffer
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$session
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statements_with_errors_or_warnings
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statements_with_full_table_scans
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statements_with_runtimes_in_95th_percentile
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statements_with_sorting
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statements_with_temp_tables
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$statement_analysis
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary_by_file_io
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary_by_file_io_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary_by_stages
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary_by_statement_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$user_summary_by_statement_type
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$waits_by_host_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$waits_by_user_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$waits_global_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$wait_classes_global_by_avg_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di vista sys.x$wait_classes_global_by_latency
-- Creazione di una tabella temporanea per risolvere gli errori di dipendenza della vista
...
-- Dump della struttura di trigger sys.sys_config_insert_set_user
...
-- Dump della struttura di trigger sys.sys_config_update_set_user
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
-- Dump della struttura del database varhunter
CREATE DATABASE IF NOT EXISTS `varhunter` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `varhunter`;

-- Dump della struttura di tabella varhunter.family
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.laboratory
...
-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.project
CREATE TABLE IF NOT EXISTS `project` (
  ...
  PRIMARY KEY (`Id`),
  KEY `User` (`User`),
  CONSTRAINT `project_ibfk_1` FOREIGN KEY (`User`) REFERENCES `user` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.sample
CREATE TABLE IF NOT EXISTS `sample` (
  `Name` varchar(255) NOT NULL,
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Project` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `sample_ibfk_1` (`Project`),
  CONSTRAINT `sample_ibfk_1` FOREIGN KEY (`Project`) REFERENCES `project` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.subject
CREATE TABLE IF NOT EXISTS `subject` (
  `Id` varchar(255) NOT NULL,
  `Family` varchar(50) DEFAULT NULL,
  `ProtocolNumber` varchar(255) DEFAULT NULL,
  `Status` varchar(255) DEFAULT NULL,
  `Sex` varchar(1) DEFAULT NULL,
  `Age` int(11) DEFAULT NULL,
  `AgeOfOnset` int(11) DEFAULT NULL,
  `GeneticStatus` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `FK_subject_family` (`Family`),
  CONSTRAINT `FK_subject_family` FOREIGN KEY (`Family`) REFERENCES `family` (`Name`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.user
CREATE TABLE IF NOT EXISTS `user` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`Laboratory`) REFERENCES `laboratory` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- L’esportazione dei dati non era selezionata.
-- Dump della struttura di tabella varhunter.variation
CREATE TABLE IF NOT EXISTS `variation` (
  `Subject` varchar(255) NOT NULL,
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Chr` varchar(7) DEFAULT NULL,
  `Start` int(11) DEFAULT NULL,
  `End` int(11) DEFAULT NULL,
  `Ref` varchar(50) DEFAULT NULL,
  `Alt` varchar(50) DEFAULT NULL,
  `Func.refgene` varchar(50) DEFAULT NULL,
  `Gene.refgene` varchar(50) DEFAULT NULL,
  `Gene.Detail.refgene` varchar(600) DEFAULT NULL,
  `ExonicFunc.refgene` varchar(50) DEFAULT NULL,
  `AAChange.refgene` varchar(1500) DEFAULT NULL,
  `1000G_ALL` float DEFAULT NULL,
  `1000G_AFR` float DEFAULT NULL,
  `1000G_AMR` float DEFAULT NULL,
  `1000G_EAS` float DEFAULT NULL,
  `1000G_EUR` float DEFAULT NULL,
  `1000G_SAS` float DEFAULT NULL,
  `ExAC_Freq` float DEFAULT NULL,
  `ExAC_AFR` float DEFAULT NULL,
  `ExAC_AMR` float DEFAULT NULL,
  `ExAC_EAS` float DEFAULT NULL,
  `ExAC_FIN` float DEFAULT NULL,
  `ExAC_NFE` float DEFAULT NULL,
  `ExAC_OTH` float DEFAULT NULL,
  `ExAC_SAS` float DEFAULT NULL,
  `ESP6500si_ALL` float DEFAULT NULL,
  `ESP6500si_AA` float DEFAULT NULL,
  `ESP6500si_EA` float DEFAULT NULL,
  `CG46` float DEFAULT NULL,
  `NCI60` float DEFAULT NULL,
  `dbSNP` varchar(50) DEFAULT NULL,
  `COSMIC_ID` varchar(100) DEFAULT NULL,
  `COSMIC_DIS` varchar(300) DEFAULT NULL,
  `ClinVar_SIG` varchar(100) DEFAULT NULL,
  `ClinVar_DIS` varchar(300) DEFAULT NULL,
  `ClinVar_STATUS` varchar(70) DEFAULT NULL,
  `ClinVar_ID` varchar(200) DEFAULT NULL,
  `ClinVar_DB` varchar(200) DEFAULT NULL,
  `ClinVar_DBID` varchar(200) DEFAULT NULL,
  `GWAS_DIS` varchar(100) DEFAULT NULL,
  `GWAS_OR` float DEFAULT NULL,
  `GWAS_BETA` float DEFAULT NULL,
  `GWAS_PUBMED` int(11) DEFAULT NULL,
  `GWAS_SNP` varchar(50) DEFAULT NULL,
  `GWAS_P` double DEFAULT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `variation_ibfk_2` (`Sample`),
  KEY `variation_ibfk_1` (`Subject`),
  CONSTRAINT `variation_ibfk_1` FOREIGN KEY (`Subject`) REFERENCES `subject` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `variation_ibfk_2` FOREIGN KEY (`Sample`) REFERENCES `sample` (`Id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=77508 DEFAULT CHARSET=utf8;
